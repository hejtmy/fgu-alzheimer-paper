...
str(freezes$data)
```
This settings leads to `r freezes$summary$n_freezes` instances of freezing behavior for a total duration of `r sum(freezes$duration)` seconds, ergo `r round(freezes$summary$time_ratio*100, 2)`. percent of the entire time.
